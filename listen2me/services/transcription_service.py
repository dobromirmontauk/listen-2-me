...
from listen2me.transcription.consumers import TranscriptionConsumer
...
class TranscriptionService:
    ...
    def start_transcription_consumers(self, chunks_per_second: float) -> Dict[str, Any]:
        ...
        # Create and configure consumers
        self.realtime_consumer = TranscriptionConsumer(
            name="realtime",
            backend=backend,
        ...
        self.batch_consumer = TranscriptionConsumer(
            name="batch",
            backend=backend,
